...
export default function SadorFashionStore() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-orange-50">
      <div className="bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 text-white py-2 sm:py-3 px-2 sm:px-4 text-center shadow-sm">
      ...
      <header className="border-b border-pink-200/50 bg-white/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/90 sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full flex items-center justify-center shadow-md">
            ...
            <nav className="hidden md:flex items-center space-x-8 lg:space-x-12">
              <Link
                href="#shop"
                className="text-gray-700 hover:text-pink-500 transition-all duration-200 font-bold text-sm tracking-widest"
              >
                SHOP
              </Link>
              <Link
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg bg-gradient-to-r from-pink-500 to-orange-500 text-white shadow-md hover:shadow-lg transition-all duration-200"
            >
            ...
            <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-xl border-b border-pink-200/50 shadow-lg">
              <nav className="px-4 py-6 space-y-4">
                <Link
                  ...
                  className="block text-gray-700 hover:text-pink-500 transition-all duration-200 font-bold text-lg tracking-widest py-2 border-b border-pink-100"
                >
                  SHOP
                </Link>
                <Link
                ...
                <Link
                  href="#gift-shop"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block text-gray-700 hover:text-pink-500 transition-all duration-200 font-bold text-lg tracking-widest py-2"
                >
                  GIFT SHOP
                </Link>
              </nav>
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4 sm:px-6">
          <div className="space-y-6 sm:space-y-10">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="w-20 sm:w-32 h-1 sm:h-2 bg-gradient-to-r from-yellow-400 to-orange-400 mx-auto shadow-md rounded-full"></div>
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-[0.1em] sm:tracking-[0.2em] opacity-95 drop-shadow-lg text-yellow-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center pt-6 sm:pt-10">
              <Button
                size="lg"
                className="bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 hover:from-yellow-500 hover:to-orange-600 font-black px-8 sm:px-16 py-4 sm:py-6 text-lg sm:text-xl tracking-wide shadow-lg hover:shadow-yellow-400/25 transition-all duration-200 border-0 rounded-full"
              >
                SHOP NOW
              </Button>
              <Link href="https://t.me/sador_onlineshop">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 sm:border-3 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-gray-900 font-black px-8 sm:px-16 py-4 sm:py-6 text-lg sm:text-xl tracking-wide bg-transparent backdrop-blur-sm transition-all duration-200 shadow-lg rounded-full"
                >
                  JOIN TELEGRAM
                </Button>
              </Link>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-12 sm:mb-16">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="w-16 sm:w-24 h-1 sm:h-2 bg-gradient-to-r from-pink-500 to-orange-500 mx-auto shadow-md rounded-full"></div>
            </div>
          </div>
      ...
      <section id="shop" className="py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-pink-50 via-white to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
            <Card className="border-0 bg-gradient-to-br from-pink-100 to-pink-50 shadow-lg hover:shadow-pink-200/50 transition-all duration-200">
            ...
            <Card className="border-0 bg-gradient-to-br from-orange-100 to-orange-50 shadow-lg hover:shadow-orange-200/50 transition-all duration-200">
              <CardContent className="p-6 sm:p-8 lg:p-10 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 lg:space-x-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
            {featuredProducts.map((product, index) => (
              <Card
                key={index}
                className="group border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white overflow-hidden hover:scale-102 hover:-translate-y-1 rounded-3xl"
              >
                <div className="relative overflow-hidden rounded-t-3xl">
                 <Image
                  ...
                  <div className="absolute top-3 sm:top-4 right-3 sm:right-4">
                    {product.inStock ? (
                      <Badge className="bg-gradient-to-r from-green-400 to-green-500 text-white px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-bold shadow-sm rounded-full">
                        IN STOCK
                      </Badge>
                    ) : (
                      <Badge className="bg-gradient-to-r from-orange-400 to-red-500 text-white px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-bold shadow-sm rounded-full">
                        PRE-ORDER
                      </Badge>
                    )}
                  </div>
                  <div className="absolute top-3 sm:top-4 left-3 sm:left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    <div className="flex space-x-1">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className="h-3 w-3 sm:h-4 sm:w-4 fill-yellow-400 text-yellow-400 drop-shadow-sm"
                        />
                      ))}
                    </div>
                  </div>
                ...
                <CardContent className="p-6 sm:p-8 space-y-4 sm:space-y-6">
                  ...
                  <Button className="w-full bg-gradient-to-r from-pink-500 to-orange-500 text-white hover:from-pink-600 hover:to-orange-600 font-black py-3 sm:py-4 text-base sm:text-lg transition-all duration-200 shadow-md hover:shadow-pink-500/25 rounded-full">
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-pink-50 via-white to-orange-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            <Card className="border-0 shadow-md hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-blue-50 to-blue-100 hover:scale-102 hover:-translate-y-1 rounded-3xl">
              <CardContent className="p-8 sm:p-10 lg:p-12 text-center space-y-6 sm:space-y-8">
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto shadow-md">
            ...
            <Card className="border-0 shadow-md hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-green-50 to-green-100 hover:scale-102 hover:-translate-y-1 rounded-3xl">
              <CardContent className="p-8 sm:p-10 lg:p-12 text-center space-y-6 sm:space-y-8">
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto shadow-md">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-bold shadow-sm rounded-full">
            ...
            <Card className="border-0 shadow-md hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-purple-50 to-purple-100 hover:scale-102 hover:-translate-y-1 rounded-3xl sm:col-span-2 lg:col-span-1">
              <CardContent className="p-8 sm:p-10 lg:p-12 text-center space-y-6 sm:space-y-8">
                <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto shadow-md">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <Badge className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base font-bold shadow-sm rounded-full">
                    Up to 15% off
                  </Badge>
                </div>
              </CardContent>
      ...
      <section id="contact" className="py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-pink-50 via-white to-orange-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          <div className="inline-flex items-center justify-center space-x-3 sm:space-x-4 text-gray-700 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full px-6 sm:px-8 py-4 sm:py-6 shadow-md border border-green-200">
      ...
      <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-10">
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full flex items-center justify-center shadow-md">
